...
| [`improvement-proposal-2026-07.md`](./improvement-proposal-2026-07.md) | **改善提案（2026-07・最新）**。外部批評（READMEネタバレ／リプレイ耐性／初見の理不尽化／研修運用）への応答：ネタバレ隔離・配属シャッフル（シード乱数化）・初見救済・研修キット。**提案のみ・実装は未着手** |
...
docs/design-revision-2026-07.md   ← 設計改訂（実装済み）
        │  外部批評 → 改善提案
        ▼
docs/improvement-proposal-2026-07.md ← 改善提案（最新・実装待ち）
```
