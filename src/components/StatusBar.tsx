  ...
  return (
    <header className="status">
      <div className="status__year">
        ...
        <span className="status__year-unit">年目</span>
        <span className="status__year-total">/ 全10年</span>
      </div>

      <div className="status__score">
        <span className="status__score-label">累積部署成果</span>
      ...
      <div className="status__meters">
        <Meter
          label="信頼"
          detail={`${TIER_LABEL[tier]}　観測ノイズ ±${noisePct}%`}
          value={tn}
          color="#4db6a8"
        />
        {state.promoted && (
